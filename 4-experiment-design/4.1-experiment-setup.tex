...
\hl{The gyroscope, a Sensonor STIM300 (shown in figure \mbox{\ref{fig::4-1_stim300}}) frequently used in aerospace applications such as rockets, is mounted directly on the telescope to measure the movements of the imaging unit with maximum precision without additional mechanical or electrical interfaces.}
\begin{figure}[htb]
	\centering
