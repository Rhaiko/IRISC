...
\hl{The imaging spectrum of the NIR imaging sensor is illustrated in figure {\ref{fig::4.1-NIR_spectrum}.} }
...
\begin{figure}[h]
	...
	\begin{minipage}[t]{0.3\linewidth}
		...
		\caption{ZWO ASI183MM (mono) \hl{(NIR camera)}} 
	...
	\begin{minipage}[t]{0.3\linewidth}
		...
		\caption{ZWO ASI290 Mini (mono) (guiding camera) \hl{[new figure]}} 
...
\begin{figure}[H]
	...
	\caption{Imaging spectrum of the NIR camera \hl{[new figure]}}
...
\begin{figure}[H]
	...
	\caption{Imaging spectrum of the guiding camera \hl{[new figure]}}
