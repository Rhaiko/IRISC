...
\smallskip
\textit{Previous Education}: BSc(Astronomy)(Hons) with a focus on radio astronomy research and instrumentation from Curtin University.

\smallskip
\textit{Responsibilities}: experiment scientific background and objectives; data and image analysis; documenting and publishing findings.
