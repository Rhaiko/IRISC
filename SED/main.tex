...
%TODO \renewcommand*{\appendixsection}{Appendix~\arabic{section}}
...
\fancypagestyle{SED}
{
    ...
    \fancyfoot[RE,LO]{\textit{BX28\_IRISC\_SEDv1-0\_16Jan19}}
...
\fancypagestyle{cover}
{
   ...
   \lfoot{\centering\textit{BX28\_IRISC\_SEDv1-0\_16Jan19}}
  %\cfoot{}
  % \rfoot{} 
}
...
\fancypagestyle{firstp}
{
   ...
   \chead{-\hspace{0.05cm}\thepage \hspace{0.05cm}-}
   \renewcommand{\footrulewidth}{0.5pt}  
   \fancyfoot[RE,LO]{\textit{BXxx\_xxx\_SEDvx-x\_00xxx19}}
...
& \hspace{3pt}\multirow{3}{*}{\includegraphics[width=.25\textwidth]{0-cover/img/logo-irisc.png}} %% HERE IS WHERE YOU INPUT YOUR OWN LOGO!!
\end{tabular}
\end{flushright}
\begin{flushleft}
\vspace{5pt}
