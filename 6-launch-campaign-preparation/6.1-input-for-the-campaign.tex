...
\hl{In order to test functionality and make any adjustments that may be necessary, we also request an oscilloscope with probes, a 2m x 1m table, at least 4 power sockets, 2 torque wrenches and a dynamometer capable of measuring at least 10N. We also request late access to the gondola in order to remove the covers for the telescope and guiding scope}
