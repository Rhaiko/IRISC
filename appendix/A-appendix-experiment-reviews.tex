...
% I leave this here as the example of how to use the pdf call function and not have the title of the section on a different page to the image of the pdf.
 ...
 \includepdf[scale=0.8,pages={1}, pagecommand=\subsection{Integration Progress Review (IPR)},offset=0 -1cm]{appendix/ExperimentReviews/IPR_Report.pdf}
 \includepdf[scale=0.8,pages={2,3,4,5,6,7},pagecommand={}]{appendix/ExperimentReviews/IPR_Report.pdf}
 
  \includepdf[scale=0.8,pages={1}, pagecommand=\subsection{Experiment Acceptance Review (EAR)},offset=0 -1cm]{appendix/ExperimentReviews/EAR_Report.pdf}
 \includepdf[scale=0.8,pages={2,3,4,5,6,7},pagecommand={}]{appendix/ExperimentReviews/EAR_Report.pdf}
